              ...
              console.log('Generando SKU...');
                  ...
                  this.sku = `${prefix}-${categoryCode}-${month}/${year}-${random}`;
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="currency" name="currency"
                                ...
                                <option value="NIO" {{ old('currency') == 'NIO' ? 'selected' : '' }}>NIO (Córdoba)
                                </option>
                                <option value="USD" {{ old('currency') == 'USD' ? 'selected' : '' }}>USD (Dólar)
                                </option>
                            </select>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="stock" name="stock" type="number" class="w-full" :value="old('stock')"
                                      required/>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tax_rate" name="tax_rate" type="number" step="0.01" class="w-full"
                                      :value="old('tax_rate')"
                                      required/>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="unit_of_measure" name="unit_of_measure" class="w-full"
